...
router.post('/groups/:id/assignments', upload_middleware_1.uploadMiddleware.single('file'), upload_middleware_1.validateDocumentMiddleware, subscription_middleware_1.checkAssignmentLimitMiddleware, subscription_middleware_1.incrementAssignmentCountMiddleware, (0, validate_middleware_1.validate)(assignment_schema_1.createAssignmentSchema), assignment_controller_1.createAssignmentController);
...
router.post('/:id/submissions', upload_middleware_1.uploadMiddleware.single('file'), upload_middleware_1.validateDocumentMiddleware, (0, validate_middleware_1.validate)(assignment_schema_1.submitAssignmentSchema), subscription_middleware_1.checkSubmissionLimitMiddleware, subscription_middleware_1.incrementSubmissionCountMiddleware, assignment_controller_1.submitAssignmentController);
