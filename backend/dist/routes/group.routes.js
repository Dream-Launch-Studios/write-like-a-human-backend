...
router.post("/", (0, validate_middleware_1.validate)(group_schema_1.createGroupSchema), auth_middleware_1.adminMiddleware, auth_middleware_1.teacherMiddleware, group_controller_1.createGroupController);
